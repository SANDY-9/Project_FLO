 ...
 * @desc
 */
class VerticalListAdapter(private val list: List<Song>) : RecyclerView.Adapter<VerticalListAdapter.HolderView>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderView {
        return HolderView(LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_vertical, parent, false))
    }
